...
def associate(network, data, y, data_size, batch_size, time_steps, decay_threshold, learning_rate, Wt_LAST):
...
def train(network, data, y, data_size, batch_size, epochs, time_steps, lr, decay_threshold, data_output_size, bin_size, APPLICATION):
    ...
    for epoch in range(epochs):
        ...
        for i in range(data_size//batch_size):
            ...
            W, Wt_LAST, W_OUT, H, H_H = network.learn(input, label, time_steps, learning_rate, decay_threshold)
